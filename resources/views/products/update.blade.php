...
@section('content')
    @include('users.partials.header', [
        'title' => __('Actualizar Producto: ') . $product->name,
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <div class="form-group{{ $errors->has('sku') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                {!! Form::text('sku', old('sku', $product->sku), [
                        ...
                        <div class="form-group{{ $errors->has('brand') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                {!! Form::text('brand', old('brand', $product->brand), [
                        ...
                        <div class="form-group{{ $errors->has('categories') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3" style="min-height: 180px;">
                                ...
                                {!! Form::select(
                                    'categories[]',
                                    $categories,
                                    old('categories', $product->categories()->pluck('category_id')),
                                    [
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                {!! Form::number('amount', old('amount', $product->amount), [
                        ...
                        <div class="form-group{{ $errors->has('discount') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                {!! Form::number('discount', old('discount', $product->discount), [
                        ...
                        <div class="form-group{{ $errors->has('reference') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                {!! Form::text('reference', old('reference', $product->reference), [
                            ...
                            <div id="parent-list" class="col-4">
                                <output id="list">
                                    @if (Session::get('image'))
                                        <img class="img-fluid img-thumbnail rounded-lg" style="width: 100px;" src="{{ asset('argon') }}/img/products/{{ Session::get('image') }}" alt="Imagen de Referencia">
                        ...
                        <div class="text-center">
                            {!! Form::submit(__('Actualizar'), ['class' => 'btn btn-primary mt-4']) !!}
                        </div>
